...
const App = () => {
    const [popupState, setPopupState] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({
        tabHistory: [],
    });
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_tabs__WEBPACK_IMPORTED_MODULE_2__["default"], { tabHistory: popupState.tabHistory });
};
...
const UpdatedTabs = ({ tabHistory }) => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", null, tabHistory.map((item, index) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { key: index },
            "Tab ",
            index + 1,
            ": ",
            item.type,
